...
# Database Connection
try:
    conn = ibm_db.connect(  # type: ignore
...
def home():
    ...
    def send_mail(r_mail, content):
        ...
        try:
            server.login(s_mail,s_pass)  # type: ignore
    ...
    if request.method == 'POST':
        ...
        if(password==confirm_password):
            ...
            account = ibm_db.fetch_assoc(stmt)  # type: ignore
            print(account)
            ...
            if account:
                ...
                try:
                    ...
                    ibm_db.exec_immediate(conn, insert_query)  # type: ignore
